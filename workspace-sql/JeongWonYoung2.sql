...
--
ALTER TABLE EZEN.TB_EMP ADD CONSTRAINT FK_TB_EMP2 FOREIGN KEY(EMP_NO) REFERENCES EZEN.TB_EMP(EMP_NO);
--
...
COMMENT ON COLUMN EZEN.TB_SAL_HIS_DTL.PAY_DTL_AMT IS '지급상세내역';
