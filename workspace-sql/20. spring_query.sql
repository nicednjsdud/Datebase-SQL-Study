...
VALUES(0, 'test', 'test', 'test', '01000000', '한식', '1만원', '가능', '00~00', '232', '삼겹살');

INSERT INTO ADMIN.RESTAURANT_INFO
(RESTIDX, RESTNAME, RESTADDRESS, RESTJIBUNADDRESS, RESTPHONE, RESTMENU, RESTPRICE, RESTPARK, RESTOPEN, RESTMENULIST, RESTTAG)
VALUES(1, 'test', 'test', 'test', '01000000', '한식', '1만원', '가능', '00~00', '232', '삼겹살');

INSERT INTO ADMIN.RESTAURANT_INFO
(RESTIDX, RESTNAME, RESTADDRESS, RESTJIBUNADDRESS, RESTPHONE, RESTMENU, RESTPRICE, RESTPARK, RESTOPEN, RESTMENULIST, RESTTAG)
VALUES(2, 'test', 'test', 'test', '01000000', '한식', '1만원', '가능', '00~00', '232', '삼겹살');

INSERT INTO ADMIN.RESTAURANT_INFO
(RESTIDX, RESTNAME, RESTADDRESS, RESTJIBUNADDRESS, RESTPHONE, RESTMENU, RESTPRICE, RESTPARK, RESTOPEN, RESTMENULIST, RESTTAG)
VALUES(3, 'test', 'test', 'test', '01000000', '한식', '1만원', '가능', '00~00', '232', '삼겹살');

INSERT INTO ADMIN.RESTAURANT_INFO 
(RESTIDX, RESTNAME, RESTADDRESS, RESTJIBUNADDRESS, RESTPHONE, RESTMENU, RESTPRICE, RESTPARK, RESTOPEN, RESTMENULIST, RESTTAG)
VALUES(4, 'test', 'test', 'test', '01000000', '한식', '1만원', '가능', '00~00', '232', '삼겹살');

INSERT INTO ADMIN.RESTAURANT_INFO
(RESTIDX, RESTNAME, RESTADDRESS, RESTJIBUNADDRESS, RESTPHONE, RESTMENU, RESTPRICE, RESTPARK, RESTOPEN, RESTMENULIST, RESTTAG)
VALUES(0, 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test','test');
